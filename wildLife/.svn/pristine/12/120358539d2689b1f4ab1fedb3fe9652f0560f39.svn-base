...
(function () {
    ...
    angular.module('Education.Report').controller('EggProductivityForecastReportController', EggProductivityForecastReportController);

    EggProductivityForecastReportController.$inject = [
        '$rootScope',
        '$scope',
        '$http',
        '$timeout',
    ...
    function EggProductivityForecastReportController ($rootScope, $scope, $http, $timeout,settings,service,regionService,modal,toastr,$state,blockUI,$stateParams,utils,$translate,farmService,auService,animalService) {
		...
		vm.paramDto.productTargetId = 2;    //loại hướng trứng
...
//        vm.getAllCity();
        ...
        vm.getQuantityReport=function (){
			vm.title=$translate.instant('productivityForecast.productivityForecastEgg')+ " ";
			...
			if(vm.paramDto.periodType==0){
				vm.title=vm.title+ vm.paramDto.toYear+" ("+$translate.instant('report.item2')+")";
			}else if(vm.paramDto.periodType==1){
				vm.title=vm.title+ vm.paramDto.toMonth+'/'+vm.paramDto.currentYear+" ("+$translate.instant('report.item2')+")";
			}
            ...
            service.getEggProductivityForecastReport(vm.paramDto).then(function(data){
            	vm.results=data;
...
//            	        	,
            	...
            	function createChart() {
        		    pivot.highcharts.getData({
        		    	...
        		    	data.title.text=$translate.instant('productivityForecast.productivityForecastEgg')+ " ";
						...
						if(vm.paramDto.periodType==0){
							data.title.text=data.title.text+ vm.paramDto.toYear+" ("+$translate.instant('report.item2')+")";
						}else if(vm.paramDto.periodType==1){
							data.title.text=data.title.text+ vm.paramDto.toMonth+'/'+vm.paramDto.currentYear+" ("+$translate.instant('report.item2')+")";
						}
		...
		vm.getQuantityReportDetail=function (){			
            ...
            service.getEggDetailProductivityForecastReport(vm.paramDto).then(function(data){
