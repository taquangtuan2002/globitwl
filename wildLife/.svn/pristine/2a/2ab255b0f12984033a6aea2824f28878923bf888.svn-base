...
(function () {
    ...
    angular.module('Education.Report').controller('CompareSumQuantityReportController', CompareSumQuantityReportController);

    CompareSumQuantityReportController.$inject = [
        '$rootScope',
        '$scope',
        '$http',
        '$timeout',
    ...
    function CompareSumQuantityReportController ($rootScope, $scope, $http, $timeout,settings,service,regionService,modal,toastr,$state,blockUI,$stateParams,utils,$translate,farmService,auService) {
