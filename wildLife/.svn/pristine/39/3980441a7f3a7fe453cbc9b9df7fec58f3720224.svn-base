...
(function () {
    ...
    angular.module('Education.ImportAnimal').controller('ImportAnimalController', ImportAnimalController);

    ImportAnimalController.$inject = [
        '$rootScope',
        '$scope',
        '$http',
        '$timeout',
    ...
    function ImportAnimalController ($rootScope, $scope, $http, $timeout,settings,service,modal,toastr,$state,blockUI,$stateParams,utils,$translate,Upload,FarmService,fmsAdministrativeService) {
