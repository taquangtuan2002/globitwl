...
(function () {
    ...
    angular.module('Education.Report').controller('MeatProductivityForecastReportController', MeatProductivityForecastReportController);

    MeatProductivityForecastReportController.$inject = [
        '$rootScope',
        '$scope',
        '$http',
        '$timeout',
    ...
    function MeatProductivityForecastReportController ($rootScope, $scope, $http, $timeout,settings,service,regionService,modal,toastr,$state,blockUI,$stateParams,utils,$translate,farmService,auService,animalService) {
...
//        vm.getAllCity();
        ...
        vm.getQuantityReport=function (){
			vm.title=$translate.instant('productivityForecast.productivityForecastMeat')+ " ";
			...
			if(vm.paramDto.periodType==0){
				vm.title=vm.title + "- " + $translate.instant('report.toYear') + " " +  vm.paramDto.toYear+" ("+$translate.instant('productivityForecast.item')+")";
			}else if(vm.paramDto.periodType==1){
				vm.title=vm.title + "- " + $translate.instant('report.toMonth') + " " +  vm.paramDto.toMonth+'/'+vm.paramDto.currentYear+" ("+$translate.instant('productivityForecast.item')+")";
			}
            ...
            service.getMeatProductivityForecastReport(vm.paramDto).then(function(data){
            	vm.results=data;
...
//            	        	,
            	...
            	function createChart() {
        		    pivot.highcharts.getData({
        		    	...
        		    	data.title.text=$translate.instant('productivityForecast.productivityForecastMeat')+ " ";
						...
						if(vm.paramDto.periodType==0){
							data.title.text=data.title.text + "- " + $translate.instant('report.toYear') + " " +  vm.paramDto.toYear+" ("+$translate.instant('productivityForecast.item')+")";
						}else if(vm.paramDto.periodType==1){
							data.title.text=data.title.text + "- " + $translate.instant('report.toMonth') + " " +  vm.paramDto.toMonth+'/'+vm.paramDto.currentYear+" ("+$translate.instant('productivityForecast.item')+")";
						}
