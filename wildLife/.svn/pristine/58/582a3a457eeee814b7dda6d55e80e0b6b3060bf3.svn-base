(function () {
    ...
    angular.module('Education.Report').service('SumQuantityReportDataService', SumQuantityReportDataService);

    SumQuantityReportDataService.$inject = [
        '$http',
        '$q',
        '$filter',
        'settings',
    ...
    function SumQuantityReportDataService($http, $q, $filter, settings, utils,$translate) {
        var self = this;
		...
		self.reportAnimalDataAccordingBySearch=reportAnimalDataAccordingBySearch;
        ...
        self.updateCoordinates=updateCoordinates;
        self.getAllByParentId = getAllByParentId;
        self.getApiUsersAndRoles = getApiUsersAndRoles;
        ...
        function updateCoordinates(dto) {
            var url = settings.api.baseUrl + settings.api.apiPrefix + 'farm/updateCoordinates';
		...
		function reportAnimalDataAccordingBySearch(dto) {
            var url = settings.api.baseUrl + settings.api.apiPrefix  + 'animal_report/reportAnimalDataAccordingBySearch';
        ...
        // Call API Đồng bộ Users & Role
        function getApiUsersAndRoles(dto, successCallback, errorCallback) {
            var url = 'https://fao.gisgo.vn/users';
            return utils.resolveAlt(url, 'POST', null, dto, {
                'Content-Type': 'application/json; charset=utf-8',
                'x-secret' : '7ab6c9a86c307ef91b5b0fb993727a30fcd53f05'
            }, successCallback, errorCallback);
        }
