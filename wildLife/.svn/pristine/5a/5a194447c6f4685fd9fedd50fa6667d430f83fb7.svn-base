(function () {
    ...
    angular.module('Education.ReportFarmerManagerment').service('ReportDrugService', ReportDrugService);

    ReportDrugService.$inject = [
        '$http',
        '$q',
        '$filter',
        'settings',
    ...
    function ReportDrugService($http, $q, $filter, settings, utils) {
        var self = this;
