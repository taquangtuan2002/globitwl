...
(function () {
    ...
    angular.module('Education.Report').controller('MeatPercentOfGrowthReportController', MeatPercentOfGrowthReportController);

    MeatPercentOfGrowthReportController.$inject = [
        '$rootScope',
        '$scope',
        '$http',
        '$timeout',
    ...
    function MeatPercentOfGrowthReportController ($rootScope, $scope, $http, $timeout,settings,service,regionService,modal,toastr,$state,blockUI,$stateParams,utils,$translate,farmService,auService, ownershipService) {
...
//        vm.getAllCity();
        ...
        vm.getQuantityReport=function (){
			vm.title=$translate.instant('percentOfGrowthReport.percentOfGrowthMeat')+ " ";
            ...
            service.getPercentOfGrowthMeatReport(vm.paramDto).then(function(data){
            	vm.results=data;
				console.log(data);
...
//            	        	,
            	...
            	function createChart() {
        		    pivot.highcharts.getData({
						...
						data.title.text=$translate.instant('percentOfGrowthReport.percentOfGrowthMeat')+" ";
						if(vm.wardsName!=null){
