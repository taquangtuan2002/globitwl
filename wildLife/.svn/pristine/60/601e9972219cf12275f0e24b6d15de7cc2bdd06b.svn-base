...
(function() {
    ...
    angular.module('Education.ExportAnimal').controller('ExportAnimalDetailViewController', ExportAnimalDetailViewController);

    ExportAnimalDetailViewController.$inject = [
        '$rootScope',
        '$scope',
        '$timeout',
        'settings',
    ...
    function ExportAnimalDetailViewController($rootScope, $scope, $timeout, settings, modal, toastr, blockUI, bsTableAPI, utils, service, AnimalService, FarmService, $state, originalService,productTargetService,$translate,FmsAdministrativeService) {
		...
		vm.saveExportAnimal = function() {
            ...
            if (vm.exportAnimal.quantity > vm.exportAnimal.importAnimal.remainQuantity + vm.firstQuantity) {
