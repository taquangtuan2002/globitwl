...
(function () {
    ...
    angular.module('Education.Report').controller('MeatYieldReportController', MeatYieldReportController);

    MeatYieldReportController.$inject = [
        '$rootScope',
        '$scope',
        '$http',
        '$timeout',
    ...
    function MeatYieldReportController($rootScope, $scope, $http, $timeout, settings, service, regionService, modal, toastr, $state, blockUI, $stateParams, utils, $translate, farmService, auService, meatService, animalService) {
...
//                vm.paramDto.fromMonth = null;
//                vm.paramDto.toMonth = null;
//
//                meatService.getMeatYieldReport(vm.paramDto).then(function (data) {
//                    vm.results = data;
//                });
//            }else{
//                
//            }
            ...
            vm.paramDto.fromYear = vm.paramDto.currentYear;
