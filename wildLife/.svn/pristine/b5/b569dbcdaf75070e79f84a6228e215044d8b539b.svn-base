...
(function () {
    ...
    angular.module('Education.Report').controller('ExportQuantityReportController', ExportQuantityReportController);

    ExportQuantityReportController.$inject = [
        '$rootScope',
        '$scope',
        '$http',
        '$timeout',
    ...
    function ExportQuantityReportController ($rootScope, $scope, $http, $timeout,settings,service,regionService,modal,toastr,$state,blockUI,$stateParams,utils,$translate,farmService,auService) {
...
//        vm.getAllCity();
        ...
        vm.getQuantityReport=function (){
			...
			vm.title=$translate.instant('report.exportReport')+ " ";
			...
			vm.title=vm.title+ " ("+$translate.instant('report.item')+")";
