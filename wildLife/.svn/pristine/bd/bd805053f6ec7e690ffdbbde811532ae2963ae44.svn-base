(function () {
    ...
    angular.module('Education.ImportAnimal').service('ImportAnimalService', ImportAnimalService);

    ImportAnimalService.$inject = [
        '$http',
        '$q',
        '$filter',
        'settings',
    ...
    function ImportAnimalService($http, $q, $filter, settings, utils) {
        var self = this;
