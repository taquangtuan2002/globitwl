...
(function () {
    ...
    angular.module('Education.Report').controller('EggPercentOfGrowthReportController', EggPercentOfGrowthReportController);

    EggPercentOfGrowthReportController.$inject = [
        '$rootScope',
        '$scope',
        '$http',
        '$timeout',
    ...
    function EggPercentOfGrowthReportController ($rootScope, $scope, $http, $timeout,settings,service,regionService,modal,toastr,$state,blockUI,$stateParams,utils,$translate,farmService,auService, ownershipService) {
        ...
        vm.paramDto.type=1;//lượng trứng xuất ra 
...
//        vm.getAllCity();
		...
		function validate(){	
			if(vm.paramDto.fromYear==vm.paramDto.toYear){
				toastr.warning($translate.instant("percentOfGrowthReport.compareTimeErr"), $translate.instant("toastr.warning"));
				return false;
			}
			if(vm.paramDto.fromYear>=vm.paramDto.toYear){
				toastr.warning($translate.instant("percentOfGrowthReport.moreTimeErr"), $translate.instant("toastr.warning"));
				return false;
			}
			 return true;
		}
        ...
        vm.getQuantityReport=function (){
			...
			vm.title=$translate.instant('percentOfGrowthReport.percentOfGrowthEgg')+ " ";
			...
			vm.title=vm.title+ " ("+$translate.instant('percentOfGrowthReport.percent')+")";
            ...
            service.getPercentOfGrowthEggReport(vm.paramDto).then(function(data){
            	vm.results=data;
				console.log(data);
            	    ...
            	    report: {
            	        ...
            	        "slice": {
            	            ...
            	            "measures": [{
            	                "uniqueName": "percent",
//            	                "aggregation": "sum",
            	                "caption":$translate.instant('percentOfGrowthReport.percent')
            	            }
//            	            ,{
//            	                "uniqueName": "amount",
//            	                //"aggregation": "sum",
...
//            	        	,
            	...
            	function createChart() {
        		    pivot.highcharts.getData({
						...
						data.title.text=$translate.instant('percentOfGrowthReport.percentOfGrowthEgg')+" ";
						if(vm.wardsName!=null){
						...
						data.title.text=data.title.text+ " ("+$translate.instant('percentOfGrowthReport.percent')+")";
						data.plotOptions={};
