...
(function () {
    ...
    angular.module('Education.ImportAnimal').controller('ImportAnimalDetailController', ImportAnimalDetailController);

    ImportAnimalDetailController.$inject = [
        '$rootScope',
        '$scope',
        '$http',
        '$timeout',
    ...
    function ImportAnimalDetailController($rootScope, $scope, $http, $timeout, settings, service, modal, toastr, $state, blockUI, $stateParams, util, Uploader, FileSaver, farmService, animalService,$translate,originalService,productTargetService,injectionTimeService) {
