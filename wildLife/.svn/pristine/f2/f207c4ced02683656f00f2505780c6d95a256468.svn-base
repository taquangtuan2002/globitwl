...
(function () {
    ...
    angular.module('Education.Report').controller('PredictTheNumberOfLiveMeatSlightlyController', PredictTheNumberOfLiveMeatSlightlyController);

    PredictTheNumberOfLiveMeatSlightlyController.$inject = [
        '$rootScope',
        '$scope',
        '$http',
        '$timeout',
    ...
    function PredictTheNumberOfLiveMeatSlightlyController ($rootScope, $scope, $http, $timeout,settings,service,regionService,modal,toastr,$state,blockUI,$stateParams,utils,$translate,farmService,auService,animalService) {
...
//        vm.getAllCity();
        ...
        vm.getQuantityReport=function (){
			vm.title=$translate.instant('productivityForecast.predict_the_number_of_live_meat_slightly')+ " ";
            ...
            service.getPredictTheNumberOfLiveMeatSlightly(vm.paramDto).then(function(data){
            	vm.results=data;
...
//            	        	,
            	...
            	function createChart() {
        		    pivot.highcharts.getData({
        		    	...
        		    	data.title.text=$translate.instant('productivityForecast.predict_the_number_of_live_meat_slightly')+ " ";
