...
(function () {
    ...
    angular.module('Education.InformationAnimal').controller('FluctuationGrownupByMonthController', FluctuationGrownupByMonthController);

    FluctuationGrownupByMonthController.$inject = [
        '$rootScope',
        '$scope',
        '$http',
        '$timeout',
    ...
    function FluctuationGrownupByMonthController ($rootScope, $scope, $http, $timeout,settings,service,modal,toastr,$state,blockUI,$stateParams,utils,$translate, animalService) {
