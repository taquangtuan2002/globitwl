...
(function () {
    ...
    angular.module('Education.Report').controller('CompareExportQuantityReportController', CompareExportQuantityReportController);

    CompareExportQuantityReportController.$inject = [
        '$rootScope',
        '$scope',
        '$http',
        '$timeout',
    ...
    function CompareExportQuantityReportController ($rootScope, $scope, $http, $timeout,settings,service,regionService,modal,toastr,$state,blockUI,$stateParams,utils,$translate,farmService,auService) {
...
//        	}
        ...
        vm.getQuantityReport=function (){
			...
			vm.title=$translate.instant('report.compareExportReport')+" ";
