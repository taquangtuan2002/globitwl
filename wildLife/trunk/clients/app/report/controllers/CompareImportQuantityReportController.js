...
(function () {
    ...
    angular.module('Education.Report').controller('CompareImportQuantityReportController', CompareImportQuantityReportController);

    CompareImportQuantityReportController.$inject = [
        '$rootScope',
        '$scope',
        '$http',
        '$timeout',
    ...
    function CompareImportQuantityReportController ($rootScope, $scope, $http, $timeout,settings,service,regionService,modal,toastr,$state,blockUI,$stateParams,utils,$translate,farmService,auService) {
