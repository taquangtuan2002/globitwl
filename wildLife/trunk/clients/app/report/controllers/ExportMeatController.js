...
(function () {
    ...
    angular.module('Education.Report').controller('ExportMeatController', ExportMeatController);

    ExportMeatController.$inject = [
        '$rootScope',
        '$scope',
        '$http',
        '$timeout',
    ...
    function ExportMeatController ($rootScope, $scope, $http, $timeout,settings,service,regionService,modal,toastr,$state,blockUI,$stateParams,utils,$translate,farmService,auService,ownershipService) {
...
//        vm.getAllCity();
        ...
        vm.getQuantityReport=function (){
			vm.title=$translate.instant('report.exportMeat')+ " ";
			...
			vm.title=vm.title+ " ("+$translate.instant('report.item1')+")";
...
//            	        	,
            	...
            	function createChart() {
        		    pivot.highcharts.getData({
						...
						data.title.text=$translate.instant('report.exportMeat')+" ";
						if(vm.wardsName!=null){
						...
						data.title.text=data.title.text+ " ("+$translate.instant('report.item1')+")";
						data.plotOptions={};
