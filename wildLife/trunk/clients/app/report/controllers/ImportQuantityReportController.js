...
(function () {
    ...
    angular.module('Education.Report').controller('ImportQuantityReportController', ImportQuantityReportController);

    ImportQuantityReportController.$inject = [
        '$rootScope',
        '$scope',
        '$http',
        '$timeout',
    ...
    function ImportQuantityReportController ($rootScope, $scope, $http, $timeout,settings,service,regionService,modal,toastr,$state,blockUI,$stateParams,utils,$translate,farmService,auService) {
...
//            	        	,
            	...
            	function createChart() {
        		    pivot.highcharts.getData({
						...
						//if(data!=null && data.series!=null && data.series.length<=3){
						///	data.plotOptions.pie.colors = ['#ff9800', '#673ab7', '#e91e63'];		
						//}
