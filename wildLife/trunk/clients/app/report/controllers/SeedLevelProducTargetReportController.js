...
(function () {
    ...
    angular.module('Education.Report').controller('SeedLevelProducTargetReportController', SeedLevelProducTargetReportController);

    SeedLevelProducTargetReportController.$inject = [
        '$rootScope',
        '$scope',
        '$http',
        '$timeout',
    ...
    function SeedLevelProducTargetReportController($rootScope, $scope, $http, $timeout, settings, service, regionService, modal, toastr, $state, blockUI, $stateParams, utils, $translate, farmService, auService, animalService) {
        ...
        //vm.paramDto.groupByItems = ["animalParent","province","productTarget"];
        ...
        vm.getQuantityReport = function () {
			vm.paramDto.isLevelCommodity=true;//cấp giống loại thường
			...
			vm.paramDto.groupByItems.push('productTarget');
			
			console.log(vm.paramDto);
            service.getSeedLevelProducTargetReport(vm.paramDto).then(function (data) {
                vm.results = data;
            });
        }
