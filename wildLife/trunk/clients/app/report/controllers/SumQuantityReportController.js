...
(function () {
    ...
    angular.module('Education.Report').controller('SumQuantityReportController', SumQuantityReportController);

    SumQuantityReportController.$inject = [
        '$rootScope',
        '$scope',
        '$http',
        '$timeout',
    ...
    function SumQuantityReportController ($rootScope, $scope, $http, $timeout,settings,service,regionService,modal,toastr,$state,blockUI,$stateParams,utils,$translate,farmService,auService) {
