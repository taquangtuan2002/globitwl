...
(function () {
    ...
    angular.module('Education.Report').controller('CompareEggReportController', CompareEggReportController);

    CompareEggReportController.$inject = [
        '$rootScope',
        '$scope',
        '$http',
        '$timeout',
    ...
    function CompareEggReportController ($rootScope, $scope, $http, $timeout,settings,service,regionService,modal,toastr,$state,blockUI,$stateParams,utils,$translate,farmService,auService, ownershipService) {
...
//        	}
        ...
        vm.getQuantityReport=function (){
			...
			vm.title=$translate.instant('report.compareExportEgg')+" ";
			...
			if(vm.paramDto.periodType==0){
				vm.title=vm.title+ vm.paramDto.fromYear+ " - "+vm.paramDto.toYear+" ("+$translate.instant('report.item2')+")";
...
//        	                	 "showGrandTotals": ""
            	...
            	function createChart() {
        		    pivot.highcharts.getData({
						...
						data.title.text=$translate.instant('report.compareExportEgg')+ " ";
						if(vm.wardsName!=null){
						...
						if(vm.paramDto.periodType==0){
							data.title.text=data.title.text+ vm.paramDto.fromYear+ " - "+vm.paramDto.toYear+" ("+$translate.instant('report.item2')+")";
						}else if(vm.paramDto.periodType==1){
