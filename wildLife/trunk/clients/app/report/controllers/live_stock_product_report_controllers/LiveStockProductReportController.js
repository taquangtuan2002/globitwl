...
(function () {
    ...
    angular.module('Education.Report').controller('LiveStockProductReportController', LiveStockProductReportController);

    LiveStockProductReportController.$inject = [
        '$rootScope',
        '$scope',
        '$http',
        '$timeout',
    ...
    function LiveStockProductReportController ($rootScope, $scope, $http, $timeout,settings,service,regionService,modal,toastr,$state,blockUI,$stateParams,utils,$translate,farmService,auService,ownershipService) {
		...
		vm.paramDto.salanganeHouseType = null;
        vm.groupByItems=[
...
//        vm.getAllCity();
        ...
        vm.getQuantityReport=function (){
			...
			vm.title=$translate.instant('report.exportLiveStockProduct')+ " ";
...
//            	                "aggregation": "sum",
					...
					configChart.report.slice.measures.sorting = {
						"row": {
							"type": "desc",
							"tuple": [
								sortStr
...
//            	                "aggregation": "sum",
            	...
            	function createChart() {
        		    pivot.highcharts.getData({
						...
						data.title.text=$translate.instant('report.exportLiveStockProduct')+" ";
						if(vm.wardsName!=null){
						...
						data.title.text=$translate.instant('report.exportReportLiveStockProduct')+" ";
						if(vm.wardsName!=null){
							data.title.text=data.title.text+ vm.wardsName+ " ";
						}else if(vm.districtName!=null){
							data.title.text=data.title.text+ vm.districtName+ " ";
