...
(function () {
    ...
    angular.module('Education.Report').controller('PercentOfGrowthReportController', PercentOfGrowthReportController);

    PercentOfGrowthReportController.$inject = [
        '$rootScope',
        '$scope',
        '$http',
        '$timeout',
    ...
    function PercentOfGrowthReportController ($rootScope, $scope, $http, $timeout,settings,service,regionService,modal,toastr,$state,blockUI,$stateParams,utils,$translate,farmService,auService, ownershipService) {
...
//        vm.getAllCity();
        ...
        vm.getQuantityReport=function (){
			...
			vm.title=$translate.instant('percentOfGrowthReport.percentOfGrowthQuantity')+ " ";
			...
			if(vm.paramDto.periodType==0){
				vm.title=vm.title + vm.paramDto.fromYear +" - "+ vm.paramDto.toYear+" ("+$translate.instant('percentOfGrowthReport.percent')+")";
			}
            ...
            service.getPercentOfGrowthQuantityReport(vm.paramDto).then(function(data){
            	vm.results=data;
				console.log(data);
            	    ...
            	    report: {
            	        ...
            	        "slice": {
            	            ...
            	            "measures": [{
            	                "uniqueName": "percent",
            	                //"aggregation": "sum",
            	                "caption":$translate.instant('report.percent')
            	            }
//            	            ,{
//            	                "uniqueName": "amount",
//            	                //"aggregation": "sum",
...
//            	        	,
            	...
            	function createChart() {
        		    pivot.highcharts.getData({
        		    	...
        		    	data.title.text=$translate.instant('percentOfGrowthReport.percentOfGrowthQuantity')+ " ";
						...
						if(vm.paramDto.periodType==0){
							data.title.text=data.title.text+ vm.paramDto.fromYear +" - "+ vm.paramDto.toYear+" ("+$translate.instant('percentOfGrowthReport.percent')+")";
						}
