...
public class AnimalReportDataReportDto {
	private Integer numberOfFam;// Số hộ
	...
	private String ordo; // Bộ động vật (có vảy,cá sấu...)
	...
	private Integer numberOfFarmStatus;
	private String cites07;
	private Integer protectionLevel;

	public Integer getNumberOfFarmStatus() {
		return numberOfFarmStatus;
	}

	public void setNumberOfFarmStatus(Integer numberOfFarmStatus) {
		this.numberOfFarmStatus = numberOfFarmStatus;
	}

	public String getCites07() {
		if (cites07 == null) {
			cites07 = "Động vật rừng thông thường";
		} else {
			cites07 = "Động vật rừng thuộc Phụ lục CITES";
		}
		return cites07;
	}

	public void setCites07(String cites07) {
		this.cites07 = cites07;
	}

	public Integer getNumberOfFam() {
		return numberOfFam;
	}

	public void setNumberOfFam(Integer numberOfFam) {
		this.numberOfFam = numberOfFam;
	}
	...
	public AnimalReportDataReportDto() {

	}

	public AnimalReportDataReportDto(Integer numberOfFam, BigInteger animalId, String animalName, String animalCode,
			String scienceName, String cites, String vnlist, String vnlist06, String animalClass, String ordo,
			String family, Integer year, Integer total, Integer male, Integer female, Integer unGender,
			BigInteger provinceId, String provinceName, BigInteger districtId, String districtName, BigInteger wardId,
			String wardName, String animalGroup, Integer numberOfAnimal) {
		super();
		this.numberOfFam = numberOfFam;
		this.animalId = animalId;
		this.animalName = animalName;
	...
	public AnimalReportDataReportDto(Integer numberOfFam, BigInteger animalId, String animalName, String animalCode,
			String scienceName, String cites, String vnlist, String vnlist06, String animalClass, String ordo,
			String family, Integer year, BigInteger total, BigInteger male, BigInteger female, BigInteger unGender,
			BigInteger provinceId, String provinceName, BigInteger districtId, String districtName, BigInteger wardId,
			String wardName, String animalGroup, Integer numberOfAnimal) {
		super();
		this.numberOfFam = numberOfFam;
	...
	public AnimalReportDataReportDto(Integer numberOfFam, BigInteger animalId, String animalName, String animalCode,
			...
			String family, Integer year, BigInteger total, BigInteger male, BigInteger female, BigInteger unGender,
			BigInteger provinceId, String provinceName, BigInteger districtId, String districtName, BigInteger wardId,
			String wardName, String animalGroup, Integer numberOfAnimal, Integer protectionLevel) {
		super();
		this.numberOfFam = numberOfFam;
		this.animalId = animalId;
		this.animalName = animalName;
	...
	public String getProtectionLevelName() {
		if(this.protectionLevel != null) {
			...
			if(this.protectionLevel == 1) {
				return "Nhóm 1:I hoặc IB";
			}
			if(this.protectionLevel == 2) {
				return  "Nhóm 2:II hoặc III hoặc IIB";
			}
				
			if(this.protectionLevel == 3) {
				return  "Nhóm 3:DVRTT, Hoang dã khác";
			}
				
			if(this.protectionLevel == 4) {
				return  "Nhóm 4(khác):Không quản lý";
			}
		}
		return null;
	}
