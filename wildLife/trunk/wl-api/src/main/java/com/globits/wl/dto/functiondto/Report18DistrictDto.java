...
public class Report18DistrictDto extends Report18Dto {
	private String name;
	private String code;
	private String nameOrCode;
	private Long id;
	private Long parentDistrictId;
	private List<Report18WardDto> listWard;
	...
	public List<Report18WardDto> getListWard() {
		return listWard;
	}

	public void setListWard(List<Report18WardDto> listWard) {
