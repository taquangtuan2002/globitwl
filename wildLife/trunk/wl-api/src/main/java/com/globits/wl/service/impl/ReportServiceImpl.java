...
//        }
        ...
        if (searchDto.getListCites() != null && searchDto.getListCites().size() > 0 && searchDto.getListCites().contains("Tổng") == false && searchDto.getListCites().contains("Không xác định") == false) {
            query.setParameter("listCites", searchDto.getListCites());
        }
        result = query.getResultList();
        if (result != null && result.size() > 0) {
            for (ReportQuantityByCategoryCitesDto reportQuantityByCategoryCitesDto : result) {
                if (reportQuantityByCategoryCitesDto.getCites() == null
                        || !StringUtils.hasText(reportQuantityByCategoryCitesDto.getCites())) {
                    reportQuantityByCategoryCitesDto.setCites("Không xác định");
                } else if (searchDto.getCites() != null && searchDto.getCites().equals("Tổng")) {
                    reportQuantityByCategoryCitesDto.setCites("Tổng");
                }
